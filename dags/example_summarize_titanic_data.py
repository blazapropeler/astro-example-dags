...
default_args={
    "owner": "Blagoje Ivanovic,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-07-11", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Blagoje Ivanovic": "mailto:bivanovic@propeler.io",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clyh72obt0ck901jjjkct50vg/cloud-ide/clyh738cb0ckc01jj7jyrkvgw/clyh738mz0cv701kilbrf7ubb",
    },
)
